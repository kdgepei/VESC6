...
#define NRF_CMD_READ_REGISTER 0x00//0b00000000
#define NRF_CMD_WRITE_REGISTER 0x20//0b00100000
#define NRF_CMD_READ_RX_PAYLOAD 0x61//0b01100001 // Read RX-payload
#define NRF_CMD_WRITE_TX_PAYLOAD 0xa0//0b10100000 // Write TX-payload
#define NRF_CMD_FLUSH_TX 0xe1//0b11100001 // Flush TX FIFO
#define NRF_CMD_FLUSH_RX 0xe2//0b11100010 // Flush RX FIFO
#define NRF_CMD_REUSE_TX 0xe3//0b11100011 // Reuse last transmitted payload
#define NRF_CMD_ACTIVATE 0x50//0b01010000 // Activate features
#define NRF_CMD_READ_RX_PAYLOAD_WIDTH 0x30//0b01100000 // Read RX-payload width
#define NRF_CMD_WRITE_ACK_PAYLOAD 0xa8//0b10101000 // Write payload for ACK packet
#define NRF_CMD_WRITE_TX_PAYLOAD_NO_ACK 0xb0//0b10110000 // Disables AUTOACK on packet
