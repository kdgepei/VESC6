...
float hwtp_get_temp(void) {
	float t1 = (1.0f / ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS1]) / 10000.0f) / 3380.0f) + (1.0f / 298.15f)) - 273.15f);
	float t2 = (1.0f / ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS2]) / 10000.0f) / 3380.0f) + (1.0f / 298.15f)) - 273.15f);
	float t3 = (1.0f / ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS3]) / 10000.0f) / 3380.0f) + (1.0f / 298.15f)) - 273.15f);
	float res = 0.0f;
