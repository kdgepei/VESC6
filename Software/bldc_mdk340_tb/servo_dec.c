...
static void icuwidthcb(ICUDriver *icup) {
	...
	if (len > len_set) {
		...
		if ((len + pulse_start) > (pulse_start * 0.8f)) {
			len = 0.0f;
		} else {
 ...
 *
 * @param start
 * The amount of milliseconds the pulse starts at (default is 1.0f)
 *
 * @param end
 * he amount of milliseconds the pulse ends at (default is 2.0f)
 */
 ...
 *
 * @param servo_num
 * The servo index. If it is out of range, 0.0f will be returned.
 *
 * @return
 * The servo value in the range [-1.0f 1.0f].
 */
