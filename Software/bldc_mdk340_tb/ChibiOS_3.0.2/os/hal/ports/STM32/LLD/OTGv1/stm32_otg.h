...
#define GUSBCFG_PHYSEL          (1U<<6)     /**< USB 2.0f High-Speed PHY or
...
#define DCFG_DSPD_HS            (0U<<0)     /**< High speed (USB 2.0f).      */
#define DCFG_DSPD_HS_FS         (1U<<0)     /**< High speed (USB 2.0f) in FS
                                                 mode.                      */
